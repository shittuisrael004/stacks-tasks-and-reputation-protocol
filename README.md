...
- Practical use of STX transfers on mainnet
- Modular contract architecture
- State management with maps and data-vars
...
The protocol is split into multiple focused contracts:

1. Core protocol configuration
2. User & role management
3. Task creation, funding, assignment, and review
4. STX-based payouts
